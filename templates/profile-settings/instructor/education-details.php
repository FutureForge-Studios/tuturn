                                ...
                                <div class="tu-accordionedu">
                                    <div class="tu-expinfo">
                                        <div class="tu-accodion-holder">
                                            <h4 class="collapsed" data-bs-toggle="collapse"
                                                data-bs-target="#flush-collapseOneba<?php echo esc_attr($key); ?>"
                                                aria-expanded="true" aria-controls="flush-collapseOneba"><?php echo esc_html($education['degree_title']); ?></h4>
                                        ...
                                        <div class="tu-icon-holder">
                                            <a href="#" data-education_key="<?php echo esc_attr($key); ?>"
                                                class="tu-education-delete"><i class="icon icon-edit icon icon-trash-2 tu-deleteclr"
                                                    role="button"></i></a>
                                            <a href="#" data-education='<?php echo json_encode($education); ?>' data-operation="edit"
                                                data-education_key="<?php echo esc_attr($key); ?>" class="tu_edit_education"><i
                                                    class="icon icon-delete icon icon-edit-3 tu-editclr" role="button"></i></a>
                                        </div>
                                        <i class="icon icon-plus" role="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseOneba<?php echo esc_attr($key); ?>"
                                            aria-expanded="false" aria-controls="flush-collapseOneba"></i>
                                    </div>
                                </div>
                            </div>
                            <div id="flush-collapseOneba<?php echo esc_attr($key); ?>" class="accordion-collapse collapse"
...
<script type="text/template" id="tmpl-load-education">
    <div class="tu-expwrapper">
        <div class="tu-accordionedu">
            <div class="tu-expinfo">
                <div class="tu-accodion-holder">
                    <h4 class="collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseOneba{{data.id}}"
                        aria-expanded="false" aria-controls="flush-collapseOneba">{{data.degree_title}}</h4>
                    <ul class="tu-branchdetail">
                ...
                <div class="tu-icon-holder">
                    <a href="#" data-education_key="{{data.id}}" class="tu-education-delete"><i
                            class="icon icon-edit icon icon-trash-2 tu-deleteclr" role="button"></i></a>
                    <a href="#" data-education_key="{{data.id}}" data-operation="edit" data-education='{{JSON.stringify(data)}}'
                        class="tu_edit_education"><i class="icon icon-edit-3 tu-editclr" role="button"></i></a>
                </div>
                <i class="icon icon-plus" role="button" data-bs-toggle="collapse"
                    data-bs-target="#flush-collapseOneba{{data.id}}" aria-expanded="false" aria-controls="flush-collapseOneba"></i>
            </div>
        </div>
    </div>
    <div id="flush-collapseOneba{{data.id}}" class="accordion-collapse collapse"
        data-bs-parent="#accordionFlushExampleaa">
        <div class="tu-edubodymain">
            <div class="tu-accordioneduc">
                ...
                <div class="tu-themeform__wrap">
                    <div class="form-group">
                        ...
                        <div class="tu-placeholderholder">
                            <input type="text" id="education_degree_title" name="education[{{data.id}}][degree_title]"
                                value="{{data.degree_title}}" class="form-control tu-form-input" placeholder=" " required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="tu-placeholderholder">
                            <input type="text" id="education_institute_title"
                                name="education[{{data.id}}][institute_title]" value="{{data.institute_title}}" placeholder=" "
                                class="form-control tu-form-input" required>
                            <div class="tu-placeholder">
                                <span><?php esc_html_e('Enter title here', 'tuturn'); ?></span>
                                <em>*</em>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="tu-label"><?php esc_html_e('Location', 'tuturn'); ?></label>
                        <div class="tu-placeholderholder">
                            <input type="text" id="education_institute_location"
                                name="education[{{data.id}}][institute_location]" placeholder=" "
                                value="{{data.institute_location}}" class="form-control tu-form-input" required>
                            <div class="tu-placeholder">
                    ...
                    <?php if (empty($eductation_date_option)) { ?>
                        <div class="form-group-wrap">
                            ...
                            <div class="form-group form-group-half">
                                <div class="tu-placeholderholder">
                                    <div class="tu-calendar">
                                        <input type="text" id="tu_education_start_date" placeholder=" "
                                            name="education[{{data.id}}][education_start_date]" value="{{data.education_start_date}}"
                                            class="tu-start-date tu-datepicker form-control tu-form-input" required>
                                        <div class="tu-placeholder">
                            ...
                            <div class="form-group form-group-half">
                                <div class="tu-placeholderholder">
                                    <div class="tu-calendar">
                                        <input type="text" id="tu_education_end_date" placeholder=" "
                                            name="education[{{data.id}}][education_end_date]" value="{{data.education_end_date}}"
                                            class="tu-end-date tu-datepicker form-control tu-form-input {{ data.currently_studying == 'on' ? 'd-none' : '' }}"
                                            required>
                                        <input type="hidden" id="edu_deg_dis_able"
                                            name="education[{{data.id}}][edu_deg_dis_able]" placeholder=" "
                                            value="<?php echo esc_attr($eductation_date_option); ?>" class="form-control tu-form-input"
                                            required>
                                        <div class="tu-placeholder">
                            ...
                            <div class="form-group pt-0">
                                <div class="tu-check">
                                    <input type="checkbox" class="tu_currently_studying" placeholder=" "
                                        id="tu_currently_studying" name="education[{{data.id}}][currently_studying]"
                                        {{ data.currently_studying == 'on' ? 'checked' : '' }}>
                    ...
                    <?php if (!empty($eductation_date_option)) { ?>
                        <div class="form-group">
                            ...
                            <div class="tu-placeholderholder">
                                <input type="text" id="education_degree_desc"
                                    name="education[{{data.id}}][degree_desc]" placeholder=" "
                                    value="{{data.education_degree_desc}}" class="form-control tu-form-input" required>
                                <input type="hidden" id="edu_deg_dis_able"
                                    name="education[{{data.id}}][edu_deg_dis_able]" placeholder=" "
                                    value="<?php echo esc_attr($eductation_date_option); ?>" class="form-control tu-form-input"
                                    required>
                    ...
                    <div class="form-group tu-message-text">
                        ...
                        <div class="tu-placeholderholder">
                            <textarea class="form-control tu-form-input tu-education-description-value"
                                id="tu-education-description" name="education[{{data.id}}][education_description]" required
                                placeholder="<?php esc_attr_e('Enter description', 'tuturn'); ?>"
                                maxlength="500">{{data.education_description}}</textarea>
                        </div>
